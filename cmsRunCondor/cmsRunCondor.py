...
def cmsRunCondor(in_args=sys.argv[1:]):
    ...
    cmsrun_jobs = ht.JobSet(
        ...
        other_args={
                    ...
                    # 'getenv' : 'False',
                    'Requirements' :  '( OpSysAndVer == "CentOS7" ) && ( Machine != "hd-38-00.dice.priv" ) && ( Machine != "bc-37-00.dice.priv" ) && ( Machine != "sm00.hadoop.cluster" ) && ( Machine != "sm01.hadoop.cluster" ) && ( Machine != "sm02.hadoop.cluster" ) && ( Machine != "sm03.hadoop.cluster" ) && ( Machine != "sm04.hadoop.cluster" ) && ( Machine != "sm05.hadoop.cluster" ) && ( Machine != "sm06.hadoop.cluster" ) && ( Machine != "sm07.hadoop.cluster" ) && ( Machine != "sm08.hadoop.cluster" ) && ( Machine != "sm09.hadoop.cluster" ) && ( Machine != "sm10.hadoop.cluster" ) && ( Machine != "sm11.hadoop.cluster" ) && ( Machine != "sm12.hadoop.cluster" ) && ( Machine != "sm13.hadoop.cluster" ) && ( Machine != "sm14.hadoop.cluster" ) && ( Machine != "sm15.hadoop.cluster" ) && ( Machine != "sm16.hadoop.cluster" ) && ( Machine != "sm17.hadoop.cluster" ) && ( Machine != "sm18.hadoop.cluster" ) && ( Machine != "sm19.hadoop.cluster" ) && ( Machine != "sm20.hadoop.cluster" ) && ( Machine != "sm21.hadoop.cluster" ) && ( Machine != "sm22.hadoop.cluster" ) && ( Machine != "sm23.hadoop.cluster" ) && ( Machine != "bse00.phy.bris.ac.uk" ) && ( Machine != "bse01.phy.bris.ac.uk" ) && ( Machine != "bse02.phy.bris.ac.uk" ) && ( Machine != "bse03.phy.bris.ac.uk" ) && ( Machine != "bse04.phy.bris.ac.uk" ) && ( Machine != "bse05.phy.bris.ac.uk" ) && ( Machine != "bse06.phy.bris.ac.uk" ) && ( Machine != "bse07.phy.bris.ac.uk" ) && ( Machine != "bse08.phy.bris.ac.uk" ) && ( Machine != "bse09.phy.bris.ac.uk" ) && ( Machine != "gridftp01.phy.bris.ac.uk" ) && ( Machine != "gridftp02.phy.bris.ac.uk" ) && ( Machine != "test-wn.dice.priv" )',
                    # 'Requirements' :  '(OpSysAndVer == "CentOS7") && ( Machine != "sm00.hadoop.cluster" ) && ( Machine != "sm01.hadoop.cluster" ) && ( Machine != "sm02.hadoop.cluster" ) && ( Machine != "sm03.hadoop.cluster" ) && ( Machine != "sm04.hadoop.cluster" ) && ( Machine != "sm05.hadoop.cluster" ) && ( Machine != "sm06.hadoop.cluster" ) && ( Machine != "sm07.hadoop.cluster" ) && ( Machine != "sm08.hadoop.cluster" ) && ( Machine != "sm09.hadoop.cluster" ) && ( Machine != "sm10.hadoop.cluster" ) && ( Machine != "sm11.hadoop.cluster" ) && ( Machine != "sm12.hadoop.cluster" ) && ( Machine != "sm13.hadoop.cluster" ) && ( Machine != "sm14.hadoop.cluster" ) && ( Machine != "sm15.hadoop.cluster" ) && ( Machine != "sm16.hadoop.cluster" ) && ( Machine != "sm17.hadoop.cluster" ) && ( Machine != "sm18.hadoop.cluster" ) && ( Machine != "sm19.hadoop.cluster" ) && ( Machine != "sm20.hadoop.cluster" ) && ( Machine != "sm21.hadoop.cluster" ) && ( Machine != "sm22.hadoop.cluster" ) && ( Machine != "sm23.hadoop.cluster" ) && ( Machine != "bse00.phy.bris.ac.uk" ) && ( Machine != "bse01.phy.bris.ac.uk" ) && ( Machine != "bse02.phy.bris.ac.uk" ) && ( Machine != "bse03.phy.bris.ac.uk" ) && ( Machine != "bse04.phy.bris.ac.uk" ) && ( Machine != "bse05.phy.bris.ac.uk" ) && ( Machine != "bse06.phy.bris.ac.uk" ) && ( Machine != "bse07.phy.bris.ac.uk" ) && ( Machine != "bse08.phy.bris.ac.uk" ) && ( Machine != "bse09.phy.bris.ac.uk" ) && ( Machine != "gridftp01.phy.bris.ac.uk" ) && ( Machine != "gridftp02.phy.bris.ac.uk" ) && ( Machine != "test-wn.dice.priv" )',
